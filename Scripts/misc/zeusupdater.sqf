...
waitUntil {time > 3};
call {while {true} do {objectsToAdd = (entities "AllVehicles" - entities "Animal" - entities "RoadCone_L_F" - [Quartermaster_8, Quartermaster_5, Quartermaster_6,Quartermaster_7,Quartermaster_3,Quartermaster_4,artyMLRS,artySorcher,Quartermaster_2]); publicVariable "objectsToAdd";{_x addCuratorEditableObjects [(objectsToAdd), true]; } foreach allCurators; sleep 180;};};
